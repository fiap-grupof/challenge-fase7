...
ALTER TABLE t_sm_escolaridade ADD CONSTRAINT t_sm_escola_pk PRIMARY KEY ( id_escola );
...
CREATE TABLE t_sm_pessoa (
    ...
    nr_renda_familiar           NUMBER(7, 2) NOT NULL,
    nr_rg                       NUMBER(11),
    nr_cpf                      NUMBER(11)
);
...
ALTER TABLE t_sm_pessoa_vacina ADD CONSTRAINT t_sm_pessoa_vac_pk PRIMARY KEY ( id_relacao );
...
ALTER TABLE t_sm_contagio
    ADD CONSTRAINT t_sm_cont_t_sm_doenca_fk FOREIGN KEY ( t_sm_doenca_id_doenca )
        REFERENCES t_sm_doenca ( id_doenca )
            ON DELETE CASCADE;

ALTER TABLE t_sm_contagio
    ADD CONSTRAINT t_sm_cont_t_sm_grav_fk FOREIGN KEY ( t_sm_gravidade_id_gravidade )
        REFERENCES t_sm_gravidade ( id_gravidade )
            ON DELETE CASCADE;

ALTER TABLE t_sm_contagio
    ADD CONSTRAINT t_sm_cont_t_sm_pessoa_fk FOREIGN KEY ( t_sm_pessoa_id_pessoa )
...
ALTER TABLE t_sm_pessoa
    ADD CONSTRAINT t_sm_pessoa_t_sm_cidade_fk FOREIGN KEY ( t_sm_cidade_id_cidade )
        REFERENCES t_sm_cidade ( id_cidade )
            ON DELETE CASCADE;

ALTER TABLE t_sm_pessoa
    ADD CONSTRAINT t_sm_pessoa_t_sm_escola_fk FOREIGN KEY ( t_sm_escolaridade_id_escola )
...
ALTER TABLE t_sm_vacina
    ADD CONSTRAINT t_sm_vac_t_sm_doenca_fk FOREIGN KEY ( t_sm_doenca_id_doenca )
        REFERENCES t_sm_doenca ( id_doenca )
            ON DELETE CASCADE;
